//********************************************************************************************************************************
//*                                                                                                                              *
//*     ID3v2 Library 2.0.16.38 © 3delite 2010-2013                                                                              *
...
type
    ...
    public
        ...
        function InsertFrame(FrameID: AnsiString; Position: Integer): Integer; overload;
        ...
        function SetRawText(FrameIndex: Integer; Text: AnsiString): Boolean; overload;
        function SetRawText(FrameID: AnsiString; Text: AnsiString): Boolean; overload;
        ...
        function SetContent(FrameIndex: Integer; Content: AnsiString; LanguageID: TLanguageID; Description: AnsiString): Boolean; overload;
        function SetContent(FrameID: AnsiString; Content: AnsiString; LanguageID: TLanguageID; Description: AnsiString): Boolean; overload;
        function SetUTF8Content(FrameIndex: Integer; Content: String; LanguageID: TLanguageID; Description: String): Boolean; overload;
        function SetUTF8Content(FrameID: AnsiString; Content: String; LanguageID: TLanguageID; Description: String): Boolean; overload;
        ...
        function GetUnicodeUserDefinedURLLink(FrameIndex: Integer; var Description: String): AnsiString; overload;
        function GetUnicodeUserDefinedURLLink(FrameID: AnsiString; var Description: String): AnsiString; overload;
        function FindUnicodeUserDefinedURLLinkByDescription(Description: String; var URL: AnsiString): Integer;
        function SetUserDefinedURLLink(FrameIndex: Integer; URL: AnsiString; Description: AnsiString): Boolean; overload;
        function SetUserDefinedURLLink(FrameID: AnsiString; URL: AnsiString; Description: AnsiString): Boolean; overload;
        function SetUTF8UserDefinedURLLink(FrameIndex: Integer; URL: AnsiString; Description: String): Boolean; overload;
        function SetUTF8UserDefinedURLLink(FrameID: AnsiString; URL: AnsiString; Description: String): Boolean; overload;
        function SetUnicodeUserDefinedURLLink(FrameIndex: Integer; URL: AnsiString; Description: String): Boolean; overload;
        function SetUnicodeUserDefinedURLLink(FrameID: AnsiString; URL: AnsiString; Description: String): Boolean; overload;
        function SetUnicodeUserDefinedURLLinkByDescription(Description: String; URL: AnsiString): Boolean;
        ...
        function SetTime(FrameID: AnsiString; DateTime: TDateTime): Boolean; overload;
        function GetSEBR(FrameIndex: Integer): {$IFDEF CPUX64}Double{$ELSE}Extended{$ENDIF}; overload;
        function GetSEBR(FrameID: AnsiString): {$IFDEF CPUX64}Double{$ELSE}Extended{$ENDIF}; overload;
        function GetSEBRString(FrameIndex: Integer): AnsiString;
        function SetSEBR(FrameIndex: Integer; BitRate: AnsiString): Boolean; overload;
        function SetSEBR(FrameID: AnsiString; BitRate: AnsiString): Boolean; overload;
        {$IFNDEF CPUX64}
        ...
        function SetUserDefinedTextInformation(FrameIndex: Integer; Description: AnsiString; Text: AnsiString): Boolean; overload;
        function SetUserDefinedTextInformation(FrameID: AnsiString; Description: AnsiString; Text: AnsiString): Boolean; overload;
        function SetUTF8UserDefinedTextInformation(FrameIndex: Integer; Description: String; Text: String): Boolean; overload;
        function SetUTF8UserDefinedTextInformation(FrameID: AnsiString; Description: String; Text: String): Boolean; overload;
        function SetUnicodeUserDefinedTextInformation(FrameIndex: Integer; Description: String; Text: String): Boolean; overload;
        function SetUnicodeUserDefinedTextInformation(FrameID: AnsiString; Description: String; Text: String): Boolean; overload;
        function GetPopularimeter(FrameIndex: Integer; var Email: AnsiString; var Rating: Byte; var PlayCounter: Cardinal): Boolean;
        function FindPopularimeter(Email: AnsiString; var Rating: Byte; var PlayCounter: Cardinal): Integer;
        function SetPopularimeterByEmail(Email: AnsiString; Rating: Byte; PlayCounter: Cardinal = 0): Boolean;
        function SetPopularimeter(FrameIndex: Integer; Email: AnsiString; Rating: Byte; PlayCounter: Cardinal): Boolean;
        function FindTXXXByDescription(Description: String; var Text: String): Integer;
        ...
        function GetUnicodeListFrame(FrameID: AnsiString; var List: TStrings): Boolean; overload;
        function GetUnicodeListFrame(FrameIndex: Integer; var List: TStrings): Boolean; overload;
        function SetUnicodeListFrame(FrameID: AnsiString; List: TStrings): Boolean; overload;
        function SetUnicodeListFrame(Index: Integer; List: TStrings): Boolean; overload;
        function GetUFID(FrameIndex: Integer; var OwnerIdentifier: AnsiString): AnsiString; overload;
        function GetUFID(FrameID: AnsiString; var OwnerIdentifier: AnsiString): AnsiString; overload;
        function FindUFIDByOwnerIdentifier(OwnerIdentifier: AnsiString; var Identifier: AnsiString): Integer;
        function SetUFID(FrameIndex: Integer; OwnerIdentifier: AnsiString; Identifier: AnsiString): Boolean; overload;
        function SetUFID(FrameID: AnsiString; OwnerIdentifier: AnsiString; Identifier: AnsiString): Boolean; overload;
        function SetUFIDByOwnerIdentifier(OwnerIdentifier: AnsiString; Identifier: AnsiString): Boolean;
    end;

type
    TID3v2FrameType = (ftUnknown, ftText, ftTextWithDescription, ftTextWithDescriptionAndLangugageID, ftTextList, ftURL, ftUserDefinedURL);
...
Const
    ...
    function RIFFCreateID3v2(FileName: String; TagStream: TStream; WriteTagTotalSize: Integer; PaddingToWrite: Integer): Integer;
    function RIFFUpdateID3v2(FileName: String; TagStream: TStream; WriteTagTotalSize: Integer; PreviousTagSize: Integer; PaddingToWrite: Integer): Integer;

    function AIFFCreateID3v2(FileName: String; TagStream: TStream; WriteTagTotalSize: Integer; PaddingToWrite: Integer): Integer;
    function AIFFUpdateID3v2(FileName: String; TagStream: TStream; WriteTagTotalSize: Integer; PreviousTagSize: Integer; PaddingToWrite: Integer): Integer;

    function RF64CreateID3v2(FileName: String; TagStream: TStream; WriteTagTotalSize: Integer; PaddingToWrite: Integer): Integer;
    function RF64UpdateID3v2(FileName: String; TagStream: TStream; WriteTagTotalSize: Integer; PreviousTagSize: Integer; PaddingToWrite: Integer): Integer;
...
begin
    ...
    OR (TagStream.Position >= PreviousPosition + Self.Size);
    ...
    try
        ...
        case DataByte of
            ...
            3: begin
                ...
                Frames[FrameIndex].Stream.Seek(0, soBeginning);
                PASCIIText := AllocMem(Frames[FrameIndex].Stream.Size + 1);
                Frames[FrameIndex].Stream.Read(PASCIIText^, Frames[FrameIndex].Stream.Size - Frames[FrameIndex].Stream.Position);
                AnsiText := PASCIIText;
                FreeMem(PASCIIText);
                Result := AnsiText;
...
begin
    ...
    try
        ...
        Frames[FrameIndex].Stream.Write(PANSIChar(UTF8EncodedText)^, Length(UTF8EncodedText));
        Frames[FrameIndex].Stream.Seek(0, soFromBeginning);
        Result := True;
    except
        //*
...
function TID3v2Tag.SetContent(FrameID: AnsiString; Content: AnsiString; LanguageID: TLanguageID; Description: AnsiString): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetContent(FrameIndex: Integer; Content: AnsiString; LanguageID: TLanguageID; Description: AnsiString): Boolean;
var
    DataByte: Byte;
begin
    Result := False;
    ...
    try
        ...
        //* Set the description
        Frames[FrameIndex].Stream.Write(PANSIChar(Description)^, Length(Description) + 1);
...
function TID3v2Tag.SetUTF8Content(FrameID: AnsiString; Content: String; LanguageID: TLanguageID; Description: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
begin
    ...
    try
        ...
        Frames[FrameIndex].Stream.Write(LanguageID[0], 3);
        //* Set the description
        Frames[FrameIndex].Stream.Write(PANSIChar(DescriptionAnsi)^, Length(DescriptionAnsi) + 1);
        //* Write the content
        Frames[FrameIndex].Stream.Write(PANSIChar(ContentAnsi)^, Length(ContentAnsi));
        Frames[FrameIndex].Stream.Seek(0, soFromBeginning);
        Result := True;
    except
        //*
...
function TID3v2Tag.GetUnicodeUserDefinedURLLink(FrameID: AnsiString; var Description: String): AnsiString;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.FindUnicodeUserDefinedURLLinkByDescription(Description: String; var URL: AnsiString): Integer;
var
    FrameID: TFrameID;
    i: Integer;
    GetDescription: String;
...
begin
    ...
    FrameID := 'WXXX';
    for i := 0 to FrameCount - 1 do begin
        if Frames[i].ID = FrameID then begin
...
function TID3v2Tag.SetUnicodeUserDefinedURLLinkByDescription(Description: String; URL: AnsiString): Boolean;
var
    FrameID: TFrameID;
    i: Integer;
    GetDescription: String;
...
function TID3v2Tag.GetUnicodeUserDefinedURLLink(FrameIndex: Integer; var Description: String): AnsiString;
var
    DataByte: Byte;
    UData: Word;
    ASCIIText: PANSIChar;
...
function TID3v2Tag.SetUserDefinedURLLink(FrameID: AnsiString; URL: AnsiString; Description: AnsiString): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUserDefinedURLLink(FrameIndex: Integer; URL: AnsiString; Description: AnsiString): Boolean;
var
    DataByte: Byte;
begin
    Result := False;
...
function TID3v2Tag.SetUTF8UserDefinedURLLink(FrameID: AnsiString; URL: AnsiString; Description: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUTF8UserDefinedURLLink(FrameIndex: Integer; URL: AnsiString; Description: String): Boolean;
var
    DataByte: Byte;
    DescriptionAnsi: AnsiString;
begin
...
function TID3v2Tag.SetUnicodeUserDefinedURLLink(FrameID: AnsiString; URL: AnsiString; Description: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUnicodeUserDefinedURLLink(FrameIndex: Integer; URL: AnsiString; Description: String): Boolean;
var
    DataByte: Byte;
begin
    Result := False;
    ...
    try
        ...
        if Assigned(UnsyncronisedStream) then begin
            FreeAndNil(UnsyncronisedStream);
                   ...
                   // CPUX64
function TID3v2Tag.GetSEBR(FrameID: AnsiString): {$IFDEF CPUX64}Double{$ELSE}Extended{$ENDIF};
var
    Index: Integer;
    ID: TFrameID;
begin
...
begin
    ...
    try
        ...
        if ID3v2Size > 0 then begin
            ...
            if NOT DeleteFile(AudioFileName) then begin
...
begin
    ...
    try
        ...
        if Identification = RIFFID then begin
            Result := True;
        end;
    except
        Result := False;
...
begin
    ...
    try
        Identification := #0#0#0#0;
        TagStream.Read(Identification[0], 4);
        if Identification = AIFFID then begin
            Result := True;
        end;
    except
        Result := False;
...
begin
    ...
    try
        ...
        TagStream.Read(ChunkID, 4);
        if (ChunkID = AIFFChunkID)
        OR (ChunkID = AIFCChunkID)
        then begin
            ChunkSize := 0;
            while TagStream.Position + 8 < TagStream.Size do begin
                TagStream.Read(ChunkID, 4);
                ...
                if ChunkID = AIFFID3v2ID then begin
                    Result := ChunkSize;
                    Exit;
                end else begin
                    TagStream.Seek(ChunkSize, soCurrent);
...
begin
    ...
    try
        Identification := #0#0#0#0;
        TagStream.Read(Identification[0], 4);
        if Identification = RF64ID then begin
            Result := True;
        end;
    except
        Result := False;
...
begin
    ...
    try
        ...
        TagStream.Read(ChunkID, 4);
        if ChunkID = RIFFWAVEID then begin
            while TagStream.Position + 8 < RF64Size do begin
                TagStream.Read(ChunkID, 4);
                TagStream.Read(ChunkSize, 4);
                if (ChunkID = 'data')
                AND (ChunkSize = $FFFFFFFF)
...
function TID3v2Tag.FindCustomFrame(FrameID: AnsiString; Description: String): Integer;
var
    Index: Integer;
    ID: TFrameID;
...
function TID3v2Tag.SetUserDefinedTextInformation(FrameID: AnsiString; Description: AnsiString; Text: AnsiString): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUserDefinedTextInformation(FrameIndex: Integer; Description: AnsiString; Text: AnsiString): Boolean;
var
    DataByte: Byte;
begin
    Result := False;
...
function TID3v2Tag.SetUTF8UserDefinedTextInformation(FrameID: AnsiString; Description: String; Text: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUnicodeUserDefinedTextInformation(FrameID: AnsiString; Description: String; Text: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.GetPopularimeter(FrameIndex: Integer; var Email: AnsiString; var Rating: Byte; var PlayCounter: Cardinal): Boolean;
var
    DataByte: Byte;
    i: Integer;
begin
...
function TID3v2Tag.FindPopularimeter(Email: AnsiString; var Rating: Byte; var PlayCounter: Cardinal): Integer;
var
    i: Integer;
...
begin
    Result := - 1;
    for i := 0 to FrameCount - 1 do begin
        if Frames[i].ID = 'POPM' then begin
...
function TID3v2Tag.SetPopularimeterByEmail(Email: AnsiString; Rating: Byte; PlayCounter: Cardinal = 0): Boolean;
var
    i: Integer;
    GetEmail: AnsiString;
    GetRating: Byte;
...
function TID3v2Tag.SetPopularimeter(FrameIndex: Integer; Email: AnsiString; Rating: Byte; PlayCounter: Cardinal): Boolean;
var
    DataByte: Byte;
    Value: Cardinal;
begin
...
begin
    ...
    for i := 0 to FrameCount - 1 do begin
        if ID = Frames[i].ID then begin
            GetContent := GetUnicodeTXXX(i, GetDescription);
            if WideUpperCase(GetDescription) = WideUpperCase(Description) then begin
                Text := GetContent;
                Result := i;
                Break;
...
function TID3v2Tag.GetUnicodeTXXX(FrameIndex: Integer; var Description: String): String;
var
    DataByte: Byte;
    UData: Word;
    ASCIIText: PANSIChar;
...
function TID3v2Tag.GetUnicodeListFrame(FrameID: AnsiString; var List: TStrings): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUnicodeListFrame(FrameID: AnsiString; List: TStrings): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.GetUFID(FrameID: AnsiString; var OwnerIdentifier: AnsiString): AnsiString;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.FindUFIDByOwnerIdentifier(OwnerIdentifier: AnsiString; var Identifier: AnsiString): Integer;
var
    FrameID: TFrameID;
    i: Integer;
...
function TID3v2Tag.SetUFIDByOwnerIdentifier(OwnerIdentifier: AnsiString; Identifier: AnsiString): Boolean;
var
    FrameID: TFrameID;
    i: Integer;
    GetOwnerIdentifier: AnsiString;
...
function TID3v2Tag.GetUFID(FrameIndex: Integer; var OwnerIdentifier: AnsiString): AnsiString;
var
    DataByte: Byte;
begin
    Result := '';
...
function TID3v2Tag.SetUFID(FrameID: AnsiString; OwnerIdentifier: AnsiString; Identifier: AnsiString): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUFID(FrameIndex: Integer; OwnerIdentifier: AnsiString; Identifier: AnsiString): Boolean;
var
    DataByte: Byte;
begin
    Result := False;
    ...
    try
        ...
        Frames[FrameIndex].Stream.Write(PANSIChar(OwnerIdentifier)^, Length(OwnerIdentifier) + 1);
        //* Write the Identifier
        Frames[FrameIndex].Stream.Write(PANSIChar(Identifier)^, (Length(Identifier)));
        Frames[FrameIndex].Stream.Seek(0, soFromBeginning);
        Result := True;
    except
        //*
